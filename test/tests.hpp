...
using StringBaseTestTypes = testing::Types<
...
TYPED_TEST_SUITE(StringBaseTest, StringBaseTestTypes);
...
using StringCoreTestTypes = testing::Types<
...
TYPED_TEST_SUITE(StringCoreTest, StringCoreTestTypes);
